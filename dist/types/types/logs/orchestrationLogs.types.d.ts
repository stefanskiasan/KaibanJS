...
export type OrchestrationStatusLog = OrchestrationActivatedLog | OrchestrationDeactivatedLog | OrchestrationAnalysisLog | TaskSelectionLog | TaskAdaptationLog | TaskGenerationLog | WorkflowOptimizationLog | OrchestrationCompletedLog | OrchestrationErrorLog | TaskRepositoryLog | PerformanceMonitoringLog | TaskCompletionAnalysisLog | OrchestrationDecisionsLog;
export type OrchestrationEventType = 'ACTIVATED' | 'DEACTIVATED' | 'ANALYSIS_STARTED' | 'TASK_SELECTION' | 'TASK_ADAPTATION' | 'TASK_GENERATION' | 'OPTIMIZATION_STARTED' | 'CONTINUOUS_OPTIMIZATION' | 'COMPLETED' | 'ERROR' | 'TASK_REPOSITORY_UPDATE' | 'PERFORMANCE_MONITORING' | 'TASK_COMPLETION_ANALYSIS' | 'ORCHESTRATION_DECISIONS' | 'PERFORMANCE_METRICS_SUMMARY' | 'FALLBACK_TASK_SELECTION' | 'FALLBACK_TASK_ADAPTATION' | 'FALLBACK_TASK_GENERATION' | 'LLM_RECOVERY_SUCCESS' | 'LLM_RECOVERY_FAILED' | 'WORKFLOW_RECOVERY' | 'GENERIC_RECOVERY' | 'EMERGENCY_TASK_CREATED' | 'RECOVERY_SUCCESS' | 'CONTINUOUS_ORCHESTRATION_STARTED' | 'CONTINUOUS_ORCHESTRATION_COMPLETED' | 'CONTINUOUS_ORCHESTRATION_ERROR' | 'TASK_COMPLETION_ANALYSIS_ERROR' | 'RECOMMENDATIONS_APPLIED' | 'RECOMMENDATIONS_APPLICATION_ERROR' | 'CONTINUOUS_TASK_GENERATION' | 'HEALTH_CHECK' | 'CONFIG_VALIDATION' | 'CONTINUOUS_TASK_SELECTION' | 'TASK_SPLIT_RECOMMENDED' | 'TASK_MERGE_RECOMMENDED' | 'ORCHESTRATION_ERROR' | 'GAP_ANALYSIS_COMPLETED' | 'HIGH_RISK_TASKS_IDENTIFIED' | 'RESOURCE_OPTIMIZATION' | 'TASKS_REDISTRIBUTED' | 'TASK_RETRY' | 'TASK_REASSIGNED' | 'TASK_SPLIT_FOR_RECOVERY' | 'FALLBACK_TASK_CREATED' | 'TASK_SKIPPED' | 'LEARNING_INSIGHTS' | 'STRATEGY_ADJUSTED';
